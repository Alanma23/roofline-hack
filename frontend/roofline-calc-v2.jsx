...
const HW_PRESETS = {
  ...
  "GB10 Blackwell": { bw: 287, bwRange:[250,320], flops:{FP32:31,FP16:62,BF16:62,FP8_E4M3:124,FP8_E5M2:124,NVFP4:1000,MXFP4:1000,INT8:124,INT4:248}, note:"Blackwell B10 (GX10) · ASUS Ascent · Real specs" },
...
function GEMMAnalyzer({ hw, hwKey, onMeasuredPoints, onClearMeasured }) {
  ...
  const analyze = async () => {
    ...
    try {
      ...
      setResult(data);
      // Pass measured points up to parent for overlay (all precisions if sweep enabled)
